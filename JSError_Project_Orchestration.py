...
class JSError_Project_Orchestration(unittest.TestCase):
    def setUp(self):
    ...
    def test_JSError_Project_Orchestration(self):
        driver = self.driver
        ...
        driver.find_element_by_xpath("//dd/div/h4[text()[contains(.,'Orchestration')]]").click()
        driver.find_element_by_xpath("//dd/div//a[text()='Stacks' and @href='/project/stacks/']").click()
        driver.find_element_by_xpath("//dd/div//a[text()='Resource Types' and @href='/project/stacks/resource_types/']").click()
