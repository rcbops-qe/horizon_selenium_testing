...
class Create_New_Instance_with_Security_Rules_and_Network(unittest.TestCase):
    def setUp(self):
    ...
    def test_Create_New_Instance_with_Security_Rules_and_Network(self):
        driver = self.driver
        ...
        for i in driver.find_elements_by_xpath("//label[contains(text(), 'Security Groups')]/..//input"):
            if i.get_attribute('value') == 'horizon_security_test' or i.get_attribute('checked'):
                i.click()
