...
class JSError_Project_Network(unittest.TestCase):
    def setUp(self):
    ...
    def test_JSError_Project_Network(self):
        driver = self.driver
        ...
        driver.find_element_by_xpath("//dd/div//a[text()='Network Topology' and @href='/project/network_topology/']").click()
        driver.find_element_by_xpath("//dd/div//a[text()='Networks' and @href='/project/networks/']").click()
        driver.find_element_by_xpath("//dd/div//a[text()='Routers' and @href='/project/routers/']").click()
