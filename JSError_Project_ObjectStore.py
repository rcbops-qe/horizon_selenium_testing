...
class JSError_Project_ObjectStore(unittest.TestCase):
    def setUp(self):
    ...
    def test_JSError_Project_ObjectStore(self):
        driver = self.driver
        ...
        driver.find_element_by_xpath("//dd/div/h4[text()[contains(.,'Object Store')]]").click()
        driver.find_element_by_xpath("//dd/div//a[text()='Containers' and @href='/project/containers/']").click()
